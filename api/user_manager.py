...
class PanelWebhookHandler:
    ...
    async def handle_webhook(self, request):
        ...
        elif event in ["user.expires_in_72_hours", "user.expires_in_48_hours", "user.expires_in_24_hours"]:
    ...
    async def _handle_expired(self, tg_id: int, user_data: dict):
        ...
        expire_date = user_data.get('expireAt', '')[:10] if user_data.get('expireAt') else ''
